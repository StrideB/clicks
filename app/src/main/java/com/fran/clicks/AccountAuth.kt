 ...
 * Google **ID token**; the app sends it to the Clicks AI proxy (Cloudflare Worker), which verifies it
...
object GeminiProxy {
    ...
    // Your deployed Worker, e.g. https://clicks-gemini.<subdomain>.workers.dev . Overridable via pref.
