...
import com.fran.teclas.db.NgramDatabase
import com.fran.teclas.db.NgramEntry
...
class SmsSeedingCoordinator(private val context: Context) {
    ...
    private val prefs = context.getSharedPreferences("teclas_prefs", Context.MODE_PRIVATE)
