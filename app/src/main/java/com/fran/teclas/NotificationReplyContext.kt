...
/**
 * Zero-keystroke reply chips. Reads the messages the existing TeclasNotificationListener already
 * persisted to the shared "teclas" prefs (no second notification service), takes the most recent
