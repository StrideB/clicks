...
internal data class SearchResult(val title: String, val subtitle: String, val accent: Int, val kind: SearchKind, val target: PaneTarget?, val action: (() -> Unit)? = null, val longAction: (() -> Unit)? = null)
internal enum class SearchKind { APP, CONTACT, EMAIL, MESSAGE, CALENDAR, AI, TRAVEL, MUSIC, FILE, SETTING, WEB, ANSWER, RIDE }
