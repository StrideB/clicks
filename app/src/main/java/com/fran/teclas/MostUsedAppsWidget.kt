...
import com.fran.teclas.grid.GridIcons
import org.json.JSONObject
import kotlin.math.roundToInt

/**
 * "Teclas · Most Used" home-screen widget: the user's top-launched apps as tappable icons.
 * Ranks by the same launch counter the launcher's favorites dock uses (app_usage_counts in the
 * "teclas" prefs), so it needs no extra permissions and works in any launcher — including the
