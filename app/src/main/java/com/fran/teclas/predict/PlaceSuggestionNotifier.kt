...
object PlaceSuggestionNotifier {
    ...
    const val ACTION_ACCEPT = "com.fran.teclas.PLACE_SUGGESTION_ACCEPT"
    const val ACTION_DISMISS = "com.fran.teclas.PLACE_SUGGESTION_DISMISS"
    ...
    fun show(context: Context, s: PlaceInference.Suggestion) {
        ...
        manager.createNotificationChannel(
            ...
            ).apply { description = "One-tap confirmations when Teclas spots your home, work or an airport" }
        )
        ...
        val open = PendingIntent.getActivity(
            context, id,
            Intent().setClassName(context, "com.fran.teclas.SpacesSettingsActivity")
        ...
        val notification = Notification.Builder(context, CHANNEL_ID)
            .setSmallIcon(com.fran.teclas.R.drawable.ic_launcher_foreground)
            .setContentTitle(question)
            .setContentText("${s.reason}. Yes = the $name Space activates here, learned on-device.")
            .setStyle(Notification.BigTextStyle().bigText(
                "${s.reason}. Tap Yes and Teclas saves this spot as $name — the $name Space " +
