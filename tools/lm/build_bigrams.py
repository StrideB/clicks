...
SEED = {
    ...
    "know": ["what that how if you the about"],
    "think": ["about that it you we the so"],
    "make": ["sure it a the sense time money"],
    "made": ["a the it sure me sense"],
    "take": ["a the care it time your some"],
    "come": ["back over to home with here on"],
    "back": ["to home in soon later from"],
    "time": ["to for of the is and we"],
    "love": ["you it that the this to"],
    "miss": ["you it the them her him"],
    "call": ["me you the them her him back"],
    "send": ["me you it the them a"],
    "meet": ["you me at the up with"],
    "work": ["on out with for today tomorrow"],
    "home": ["now soon today tonight late by"],
    "night": ["and but so before out"],
    "morning": ["and but so before to"],
    "today": ["and but so at because"],
    "tomorrow": ["morning night and at but"],
    "did": ["you it not the they he she we"],
    "does": ["it that not he she anyone"],
    "were": ["you they we not going there"],
    "been": ["a the there to working trying"],
    "could": ["be you have not use do get"],
    "should": ["be have not we you i do"],
    "still": ["have not here there waiting working"],
    "here": ["is are for and to now"],
    "after": ["the a work that this all"],
    "before": ["the a i you we it that"],
    "because": ["i you it the of they we"],
    "over": ["the there here to it and"],
    "out": ["of the there to and for with"],
    "up": ["to the with for and at"],
    "down": ["to the there and on"],
    "if": ["you i we it the they that"],
    "then": ["i we you the they it"],
    "than": ["the a i you that ever"],
    "her": ["and to that she but"],
    "his": ["own and to that but"],
    "our": ["own house team family way time"],
    "their": ["own house team family way time"],
    "some": ["of time people things more good"],
    "more": ["than time of and to about"],
    "much": ["better more of to for"],
    "any": ["of time other more questions ideas"],
    "new": ["one year phone house job place"],
    "first": ["time one thing day of and"],
    "day": ["of and to for at but"],
    "week": ["and of to or but"],
    "year": ["and of to or but"],
    "people": ["are who have and to in"],
    "way": ["to of too i home better"],
    "sounds": ["good great like fun perfect"],
    "looks": ["good great like fine amazing"],
    "feel": ["like free better good bad"],
    "sorry": ["for about i to that"],
    "please": ["let send call check make do"],
    "okay": ["with so i thanks see"],
    "hope": ["you that to it all"],
    "wait": ["for until to a and"],
    "keep": ["it me you the them going"],
    "little": ["bit more while thing longer"],
    "long": ["time as day way and"],
}
